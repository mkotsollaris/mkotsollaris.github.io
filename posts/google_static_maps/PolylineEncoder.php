 ...
 *
 * The code is written using the methods and algorithms found in the work of Mark MacClure
...
{
    // The constructor
    function __construct(array $points = array(), $numLevels = 18, $zoomFactor = 2,
        $verySmall = 0.00001, $forceEndpoints = true)
    {
        $this->points = $points;
