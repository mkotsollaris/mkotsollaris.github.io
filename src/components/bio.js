...
const Bio = () => {
  ...
  return (
    <div
      ...
      />
      <p>
        👋 Welcome to my website! I am <strong>{author}</strong> and I am a Staff Software Engineer at <a href="https://realtor.com/">Realtor.com</a>.
        Thanks for visiting!
        ...
        <a href="https://github.com/mkotsollaris">
          ...
          <a href="https://stackoverflow.com/users/1373465/menelaos-kotsollaris">
            <FaStackOverflow size={28} style={{ marginRight: ".5rem" }} />
          </a>
          <a href="https://scholar.google.com/citations?user=TR8AIMsAAAAJ&hl=en">
            <FaAward size={28} style={{ marginRight: ".5rem" }} />
          </a>
          <a href="https://www.youtube.com/channel/UCFfm76gx1mxdbE7tE5X_aWA/videos">
            <FaYoutubeSquare size={28} style={{ marginRight: ".5rem" }} />
          </a>
